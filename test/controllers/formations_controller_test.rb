...
class FormationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formation" do
    assert_difference('Formation.count') do
      post formations_url, params: { formation: { description: @formation.description, mail: @formation.mail, name: @formation.name } }
    end
  ...
  test "should update formation" do
    patch formation_url(@formation), params: { formation: { description: @formation.description, mail: @formation.mail, name: @formation.name } }
